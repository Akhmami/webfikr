    ...
    <main class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div x-data="{isClose : true}" class="flex space-x-4">
            <div class="w-full">
                ...
                <div x-data="{ tab: window.location.hash ? window.location.hash : '#billing' }"
                        ...
                        <div class="hidden sm:block">
                            <div>
                                <nav class="-mb-px flex" aria-label="Tabs">
                                    <a href="#" x-on:click.prevent="tab='#billing'"
                                        :class="{ 'border-indigo-500 text-indigo-600' : tab === '#billing' }"
                                        ...
                                        <span :class="{ 'bg-indigo-100 text-indigo-600' : tab === '#billing' }"
                                            class="bg-gray-100 text-gray-900 hidden ml-3 py-0.5 px-2.5 rounded-full text-xs font-medium md:inline-block">1</span>
                                    </a>

                                    <a href="#" x-on:click.prevent="tab='#tunggakan'"
                                        :class="{ 'border-indigo-500 text-indigo-600' : tab === '#tunggakan' }"
                                        class="border-transparent text-gray-500 hover:text-gray-700 hover:border-indigo-500 border-b-2 whitespace-nowrap flex py-4 px-6 font-medium text-sm">
                                        <span>Tunggakan</span>

                                        <span :class="{ 'bg-indigo-100 text-indigo-600' : tab === '#tunggakan' }"
                                            class="bg-gray-100 text-gray-900 hidden ml-3 py-0.5 px-2.5 rounded-full text-xs font-medium md:inline-block">4</span>
                                    </a>
                                </nav>
                            </div>
                        </div>
                    ...
                    <!-- Tab Billing -->
                    <div class="divide-y" x-show="tab == '#billing'" x-cloak>
                    ...
                    <!-- Tab Tunggakan -->
                    <div class="divide-y" x-show="tab == '#tunggakan'" x-cloak>
                        <div class="flex items-center justify-between px-2 py-4">
                            <div class="text-md font-medium uppercase text-gray-700">
                                Daftar Tunggakan
                            </div>
