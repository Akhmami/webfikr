...
<div class="bg-gray-50 py-12">
    <h2 class="text-center text-gray-600 text-3xl font-extrabold tracking-tight sm:text-4xl mb-8">
        Prestasi
    </h2>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center flex-wrap sm:space-x-20">
