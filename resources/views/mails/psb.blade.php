                    ...
                    <div role="banner">
                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                style="font-size: 26px;line-height: 32px;Margin-top: 10px;Margin-bottom: 20px;color: #5a5d5e;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;"
                                align="center">
                                <div class="logo-left" align="left" id="emb-email-header"><img
                                        style="display: block;height: auto;width: 100%;border: 0;max-width: 150px;"
                                        src="https://www.nfbs.or.id/images/newlogo3.png" alt="" width="150" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                    </div>
                    <div role="section">
                        <div class="layout one-col fixed-width"
                            ...
                            <div class="layout__inner"
                                ...
                                <div class="column"
                                    style="text-align: left;color: #464748;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                    ...
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;"
                                        ...
                                        <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top"
                                            ...
                                            alt="" width="600"
                                            src="https://www.nfbs.or.id/images/5510744ae14e4e04b43b1efb6dcd8360.png" />
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                            <p class="size-18"
                                                ...
                                                lang="x-size-18"><span class="font-lato">Yth, Ayah/Bunda/Ananda
                                                    <strong>{{ ucwords($user->name) }}</strong></span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                            <p class="size-18"
                                                style="Margin-top: 0;Margin-bottom: 20px;font-family: lato,tahoma,sans-serif;font-size: 17px;line-height: 26px;"
                                                lang="x-size-18"><span class="font-lato">Nomor
                                                    pendaftaran/username anda adalah sebagai berikut:
                                                    <strong>{{$user->username}}</strong></span><br>
                                                <strong>Password login</strong> akan kami kirimkan setelah melakukan
                                                pembayaran.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;line-height: 61px;font-size: 1px;">
                                            &nbsp;</div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                            <p class="size-18"
                                                style="Margin-top: 0;Margin-bottom: 0;font-family: lato,tahoma,sans-serif;font-size: 17px;line-height: 26px;"
                                                lang="x-size-18"><span class="font-lato">Jazakallah Khairan
                                                    Katsiran.</span></p>
                                            <p class="size-18"
                                                style="Margin-top: 20px;Margin-bottom: 0;font-family: lato,tahoma,sans-serif;font-size: 17px;line-height: 26px;"
                                                lang="x-size-18"><span class="font-lato">Salam Hangat,</span></p>
                                            <p class="size-18"
                                                style="Margin-top: 20px;Margin-bottom: 0;font-family: lato,tahoma,sans-serif;font-size: 17px;line-height: 26px;"
                                                lang="x-size-18"><span class="font-lato">&nbsp;</span></p>
                                            <p class="size-18"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-family: lato,tahoma,sans-serif;font-size: 17px;line-height: 26px;"
                                                lang="x-size-18"><span class="font-lato">Panitia PSB - Nurul Fikri
                                                    Boarding School Serang</span></p>
                                        </div>
                                    </div>

                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;line-height: 64px;font-size: 1px;">
                                            &nbsp;</div>
                                    </div>

                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div class="divider"
                                            style="display: block;font-size: 2px;line-height: 2px;Margin-left: auto;Margin-right: auto;width: 40px;background-color: #ccc;">
                                            &nbsp;</div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr role="navigation">
                                                        <td class="emb-web-links" style="padding: 0;width: 26px;"><a
                                                                ...
                                                                href="https://www.facebook.com/nurulfikriserangbanten/"><img
                                                                    style="border: 0;"
                                                                    src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png"
                                                                    width="26" height="26" alt="Facebook" /></a></td>
                                                        <td class="emb-web-links"
                                                            style="padding: 0 0 0 3px;width: 26px;"><a
                                                                style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;"
                                                                href="https://twitter.com/nfbs_serang"><img
                                                                    style="border: 0;"
                                                                    src="https://i3.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png"
                                                                    width="26" height="26" alt="Twitter" /></a></td>
                                                        <td class="emb-web-links"
                                                            style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color:
#adb3b9;" href="https://www.youtube.com/channel/UC4QdCSPm8ZHf1vezxYxhHDg"><img style="border: 0;"
                                                                    src="https://i4.createsend1.com/static/eb/master/13-the-blueprint-3/images/youtube.png"
                                                                    width="26" height="26" alt="YouTube" /></a></td>
                                                        <td class="emb-web-links"
                                                            style="padding: 0 0 0 3px;width: 26px;"><a
                                                                style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;"
                                                                href="https://www.instagram.com/nfbs_serang/"><img
                                                                    style="border: 0;"
                                                        ...
                                                        <td class="emb-web-links"
                                                            style="padding: 0 0 0 3px;width: 26px;"><a
                                                                style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;"
                                                                href="https://nfbs.or.id/"><img style="border: 0;"
                                            ...
                                            <div style="font-size: 12px;line-height: 19px;Margin-top: 20px;">
                                                <div>NFBS Serang<br />
                                                    jl. Pasta Kp. Cihideng Ds. Bantarwaru Kec. Cinangka Serang-Banten
                                                    42167 telp.&nbsp;087777833303 email: humas@nfbs.or.id</div>
                                            </div>
