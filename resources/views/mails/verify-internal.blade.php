                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                            <p class="size-18"
                                                style="Margin-top: 0;Margin-bottom: 20px;font-family: lato,tahoma,sans-serif;font-size: 14px;line-height: 26px;">
                                                <span class="font-lato">
                                                    Silahkan verifikasi pendaftaran melalui klik link berikut ini
                                                    <a
                                                        href="{{ route('psb.verify', $data['crypt']) }}">psb.nfbs.or.id/verify</a>
                                                </span><br><br><br>
                                                <strong class="font-lato">
                                                    Mohon untuk tidak memberikan email ini pada siapapun, untuk
