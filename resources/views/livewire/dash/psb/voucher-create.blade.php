<div>
    <x-modal action="store">
        ...
        <x-slot name="content">
            <div class="space-y-4">
                <x-input label="Nama voucher" name="name" livewire />
                {{-- <x-select label="Jenis Kelamin" name="gender" :list="$list_jk" livewire /> --}}
                <x-input label="Senilai" type="number" name="value" livewire />
                <x-input label="Quota" type="number" name="quota" livewire />
                <x-datetime-picker label="Berlaku Sampai" name="datetime_expired" livewire />
            </div>
        </x-slot>
