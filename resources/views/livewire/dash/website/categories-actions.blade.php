<div class="flex items-center space-x-1">
    <button onclick="Livewire.emit('openModal', 'dash.website.categories-form', {{ json_encode(['id' => $data->id]) }})"
        title="edit"
    ...
    @if ($data->posts->count() < 1) <button wire:click.prevent="deleteConfirm({{ $data->id }})" title="hapus"
