<div>
    <x-modal action="add">
        ...
        <x-slot name="buttons">
            ...
            <button type="button" wire:loading.remove wire:target="add" wire:click="$emit('closeModal')" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2
