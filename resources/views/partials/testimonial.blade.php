...
<section class="py-12 bg-gray-50 overflow-hidden md:py-20 lg:py-24">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            <h2 class="text-gray-600 text-3xl font-extrabold tracking-tight sm:text-4xl text-center">
                Testimoni
            </h2>
                ...
                <footer class="mt-8">
                    <div class="md:flex md:items-center md:justify-center">
                        <div class="md:flex-shrink-0">
                            <img class="mx-auto h-10 w-10 rounded-full" src="images/user.png" alt="">
                        </div>
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base font-medium text-gray-900">Nama Alumni</div>
                            ...
                            <div class="text-base font-medium text-gray-500">angkatan 15</div>
                        </div>
                    </div>
                </footer>
            </blockquote>
