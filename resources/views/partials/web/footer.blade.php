    ...
    <div class="max-w-7xl mx-auto py-12 px-8 lg:py-16 md:px-4">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
                <img class="h-11" src="{{ asset('images/brand2.svg') }}" alt="NFBS Serang">
                ...
                <div class="flex space-x-2">
                    <a href="https://facebook.com/nurulfikriserangbanten" class="text-gray-300 bg-gray-700 p-2 rounded">
