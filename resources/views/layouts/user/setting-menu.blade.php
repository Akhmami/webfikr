<aside class="py-6 lg:col-span-3">
    <nav class="space-y-1">
        ...
        <a href="#" x-on:click.prevent="tab='#profile'"
            class="bg-blue-50 border-blue-500 text-blue-700 hover:bg-blue-50 hover:text-blue-700 group border-l-4 px-3 py-2 flex items-center text-sm font-medium"
            aria-current="page">
            <!--
                    ...
                    -->
            <svg class="text-blue-500 group-hover:text-blue-500 flex-shrink-0 -ml-1 mr-3 h-6 w-6"
